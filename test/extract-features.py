...
if __name__ == "__main__":
    ...
    # (digits, target) = load_digits("mnist_train.csv")
    # for i in range(0, len(target)):        
    #     fd = hog(np.uint8(digits[i]), orientations, pixels_per_cell, cells_per_block, visualize, normalize)
    #     if target[i] == 5:
    #         joblib.dump(fd, "features_test/pos/" + str(i) + ".feat")
    #     else:
    #         joblib.dump(fd, "features_test/neg/" + str(i) + ".feat")
